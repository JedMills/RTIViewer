...
//the three specular enhancment parameters that the use canchange with the sliders
...
void main() {
    ...
    //apply the stabdardd ptm equation to find the rgb value for this pixel
    float r = applyPTM( redCoeffs1.x, redCoeffs1.y, redCoeffs1.z,
                        redCoeffs2.x, redCoeffs2.y, redCoeffs2.z);
    float g = applyPTM( greenCoeffs1.x, greenCoeffs1.y, greenCoeffs1.z,
                        greenCoeffs2.x, greenCoeffs2.y, greenCoeffs2.z);
